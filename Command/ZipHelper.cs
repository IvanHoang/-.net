...
public static class ZipHelper
{
    ...
    public static void ZipFile(string FileToZip, string ZipedPath, string ZipedFileName = "", int CompressionLevel = 5, int BlockSize = 2048, bool IsEncrypt = true, string pwd = "")
    {
        //如果文件没有找到，则报错
    ...
    /// <param name="IsEncrypt">是否加密（默认 加密）</param>
    public static void ZipDirectory(string DirectoryToZip, string ZipedPath, string ZipedFileName = "", bool IsEncrypt = true, string pwd = "")
    {
        //如果目录不存在，则报错
